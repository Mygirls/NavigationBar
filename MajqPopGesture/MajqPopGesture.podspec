...
Pod::Spec.new do |s|
  ...
  s.name         = "MajqPopGesture"
  s.version      = "1.0.1"
  s.summary      = "A short description of MajqPopGesture."
  ...
  s.homepage     = "https://github.com/Mygirls/NavigationBar"
  ...
  s.license      = { :type => "MIT", :file => "majq LICENSE" }
  ...
  s.source       = { :git => "https://github.com/Mygirls/NavigationBar.git", :tag => "#{s.version}" }
